...
const queryComo = {
  ...
  source: '*Basados en métodos de la Terapia Cognitivo Conductual. La TCC busca entender cómo piensa uno acerca de sí mismo, de otras personas y del mundo que le rodea.',
  id: 'how',
  listData: [
    {
      img: './media/loupe.svg',
